...
//             return const Center(
//               child: Text("No News for applied Filters",style: TextStyle(color: Colors.grey,),),
//             );
//           }
//           return Padding(padding: (width > 600) ? const EdgeInsets.symmetric(horizontal: 150) : const  EdgeInsets.symmetric(horizontal: 10) ,child: _buildNewsList(state.articles, context, state.hasMore),);
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Ignore articles marked as "[Removed]"
          if (article.title == "[Removed]" && article.description == "[Removed]") {
            return Container();
          }
