...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.task == null ? "Add Task Screen" : "Edit Task", style: const TextStyle(color: Colors.white)),
        elevation: 0,
...
//     // Initialize the shaking animation
...
//                 ListTile(
//                   title: Text(
//                     "Due Date: ${_dueDate.toLocal()}".split(' ')[0],  // Format date to show only date
//                     style: TextStyle(fontSize: 16),
//                   ),
//                   trailing: Icon(Icons.calendar_today, color: Colors.deepPurple),
//                   onTap: () async {
