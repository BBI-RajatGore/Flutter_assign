...
//                 Text('Description: ${task.description}',style: const TextStyle(fontSize: 20),),
//                 const SizedBox(height: 8),
//                 Text('Due Date: ${task.dueDate}',style: const TextStyle(fontSize: 20),),
//                 const SizedBox(height: 8),
//                 Text('Priority: ${task.priority}',style: const TextStyle(fontSize: 20),),
//               ],
//             ),
//           ),
//           actions: <Widget>[
